 ...
 */
package com.malcolmlangille.aem.examples.example.it.launcher;
...
implements SlingRemoteTestParameters, SlingTestsCountChecker {
    ...
    public static final String TEST_SELECTOR = "com.malcolmlangille.aem.examples.example.it.tests";
